...
public class VarianRoti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_varian_roti);
        ...
        btnKembali.setOnClickListener(view -> {
            Intent i = new Intent(VarianRoti.this, Home.class);
            startActivity(i);
        ...
        navBarku.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.iconHome:
                        Intent intent5 = new Intent(VarianRoti.this, History.class);
                        startActivity(intent5);
                        return true;

                    case R.id.iconHistory:
                        Intent intent1 = new Intent(VarianRoti.this, History.class);
                        startActivity(intent1);
                        return true;

                    case R.id.iconSearch:
                        Intent intent2 = new Intent(VarianRoti.this, Search.class);
                        startActivity(intent2);
                        return true;

                    case R.id.iconMessage:
                        Intent intent3 = new Intent(VarianRoti.this, Messages.class);
                        startActivity(intent3);
                        return true;

                    case R.id.iconAkun:
                        Intent intent4 = new Intent(VarianRoti.this, Account.class);
